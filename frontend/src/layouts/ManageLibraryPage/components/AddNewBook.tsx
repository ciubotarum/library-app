...
export const AddNewBook = () => {
    ...
    async function base64ConversionForImgaes(e: any) {
        if (e.target.files[0]) {
                ...
                <div className="card-body">
                    <form method="POST">
                        ...
                        <div className="col-md-3 mb-3">
                            ...
                            <input type="number" className="dorm-control" name="Copies" required 
                            onChange={e => setCopies(Number(e.target.value))} value={copies} />
                        </div>
                        <input type="file" onChange={e => base64ConversionForImgaes(e)} />
                        <div>
